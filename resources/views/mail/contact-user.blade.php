    ...
    <body style="background-color: ">
        <div class="text-center">
            <h1>
                     ...
                     <img src="{{ $message->embed(public_path().'/images/SHUBHA.png') }}">
        ...
        border-bottom: 2px solid #27ae60;border-left: 2px solid #27ae60;border-right: 2px solid #27ae60; ">
            <div class="text-center">
                <h1>Dear User,</h1>
                <p style="font-size:150% ;text-align:left;">Welcome to the SHUBHAM HOTEL family!</p>
                ...
                REGARDS<br>
               Shubham Hotel<br>
               Opposite Tata Nano Agency, <br>
               Rohtak Road Near Bus Stand,<br>
                Gohana, Sonepat - 131301
                <p>
            </div>
        </div>
    </body>
